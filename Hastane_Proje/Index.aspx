...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Hastane_Proje.Index" %>
...
<body>
                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul id="nav" class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item active">
                                           <a href="Hekimlerimiz.aspx">Hekimlerimiz</a>
                                        </li>
        ...
        <div class="slider-wrapper">
            ...
            <section class="slider-section">
                <div class="slider-active slick-style">
                    <div class="single-slider img-bg" style="background-image: url('Template/assets/img/slider/slider-1.jpg');">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="slider-content">
                                        <h1 data-animation="fadeInDown" data-duration="1.5s" data-delay=".5s">
                                            Burada Özel ve Güvendesiniz
                                        </h1>
                    ...
                    <div class="single-slider img-bg" style="background-image: url('Template/assets/img/slider/slider-2.jpg');">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="slider-content">
                                        <h1 data-animation="fadeInDown" data-duration="1.5s" data-delay=".5s">
                                            En iyi Doktorlar ve Ekipmanlar
                                        </h1>
                                        <p data-animation="fadeInLeft" data-duration="1.5s" data-delay=".7s">
                                            
                                        </p>
                                        <%--<a href="Hekimlerimiz.aspx" class="btn theme-btn page-scroll" data-animation="fadeInUp" data-duration="1.5s"
                                           data-delay=".9s">
                                            Hekimlerimiz
                    ...
                    <div class="single-slider img-bg" style="background-image: url('Template/assets/img/slider/slider-3.jpg');">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="slider-content">
    ...
    <section id="about" class="about-section pt-120">
        <div class="shape shape-2">
            <img src="Template/assets/img/shapes/shape-2.svg" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-10 col-lg-11 mx-auto">
                    <div class="about-content text-center mb-55">
                        <div class="section-title mb-30">
                            ...
                            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Hastanemize Hoş Geldiniz</h2>
                        </div>
                        <p> Şifa Hastanesi, 20 bin metrekare kapalı alanda 207 yatak kapasitesi, 8 ameliyathane, 26 gözlem yatağı, 17 dahili ve cerrahi yoğun bakım ünitesi, 9 KVC yoğun bakım Ünitesi, yeni doğan yoğun bakımda 10 Kuvöz ve 5 Koroner Yoğun Bakım Ünitesi yatağı ile hizmet vermektedir
                        </p>
                        <a href="Hakkimizda.aspx" class="btn theme-btn wow fadeInUp" data-wow-delay=".8s">Tıklayınız</a>
                    </div>
                </div>
            </div>
        </div>
       <%-- <div class="about-img text-center">
            <img src="Template/assets/img/about/about-img.png" alt="">
        </div>--%>
    </section>
    <!-- ========================= about-section end ========================= -->
    ...
    <section id="services" class="service-section pt-150">
        <div class="shape shape-3">
            <img src="Template/assets/img/shapes/shape-3.svg" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="section-title text-center mb-55">
                        ...
                        <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Sağlık Hizmetlerimiz</h2>
    ...
    <section id="blog" class="blog-section pt-150">
        <div class="shape shape-7">
            <img src="Template/assets/img/shapes/shape-6.svg" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="section-title text-center mb-55">
                        ...
                        <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Son Haberler</h2>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".2s">
                        <div class="blog-img">
                            <a href="#"><img src="Template/assets/img/blog/blog-1.png" alt=""></a>
                        </div>
                        <div class="blog-content">
                            <h4>
                                
                                   Omurgadan omuriliğe uzanan tümör, 14 doktorun katıldığı 10 saatlik operasyonla çıkarıldı
                                
                            </h4>
                            <p>
                               kanser hastasının omurga ve omuriliğinde tespit edilen 15 santimetrelik tümör, hassas doku ve sinirlerin yer aldığı bölgeden 14 cerrahın 10 saatlik operasyonuyla çıkarıldı.
                            </p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".4s">
                        <div class="blog-img">
                            <a href="#"><img src="Template/assets/img/blog/blog-2.png" alt=""></a>
                        </div>
                        <div class="blog-content">
                            <h4>Başarılı ameliyat ile kanserden kurtuldu</h4>
                            <p>
                                Kuzey Irak'tan Şifa Hastanesi'ne karın ağrısı, kilo kaybı, ishal, sırta vuran ağrı şikayeti ile başvuran 67 yaşındaki Saadiya Majeed Genel Cerrahi polikliniğinde muayene oldu. Muayenenin ardından kanser olduğu teşhis Majeed, yapılan başarılı ameliyat ile sağlığına kavuştu.
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".6s">
                        <div class="blog-img">
                            <a href="#"><img src="Template/assets/img/blog/blog-3.png" alt=""></a>
                        </div>
                        <div class="blog-content">
                            <h4>Başarılı pankreas ameliyatı</h4>
                            <p>
                                Pankreas başı kanseri nedeniyle 63 yaşındaki hastamıza  genel cerrahi uzmanı  Dr.Osman Kaya ve ekibi tarafından başarılı bir şekilde whipple operasyonu yapılmıştır. Hastamız ameliyattan 8 gün sonra sağlıklı bir şekilde taburcu edilmiştir
                            </p>
