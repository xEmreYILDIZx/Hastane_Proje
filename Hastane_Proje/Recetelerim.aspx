<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recetelerim.aspx.cs" Inherits="Hastane_Proje.Recetelerim" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <asp:GridView ID="GridBilgi" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1291px">
