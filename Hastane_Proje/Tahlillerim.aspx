<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tahlillerim.aspx.cs" Inherits="Hastane_Proje.Tahlillerim" %>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <p class="m-0 text-dark">
                                <asp:GridView ID="GridTahlil" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1228px">
